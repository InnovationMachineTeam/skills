...
```bash
python3 scripts/manage_skill_dependencies.py plan agent-scout --host codex
python3 scripts/manage_skill_dependencies.py install agent-scout --host codex --execute
```
