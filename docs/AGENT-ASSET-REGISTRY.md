...
| skill | prompt-master | 1.0.0 | public | repository | — | InnovationMachineTeam | registered | `skills/prompts/prompt-master` |
...
| skill | skill-builder | 1.4.0 | public | repository | — | InnovationMachineTeam | registered | `skills/metaskills/skill-builder` |
...
| skill | skill-marketplace-manager | 1.3.0 | public | repository | — | InnovationMachineTeam | registered | `skills/metaskills/skill-marketplace-manager` |
