...
| skill | skill-best-practices | 1.0.1 | public | repository | — | InnovationMachineTeam | registered | `skills/metaskills/skill-best-practices` |
| skill | skill-builder | 1.1.0 | public | repository | — | InnovationMachineTeam | registered | `skills/metaskills/skill-builder` |
...
| skill | skill-marketplace-manager | 1.0.0 | public | repository | — | InnovationMachineTeam | registered | `skills/metaskills/skill-marketplace-manager` |
