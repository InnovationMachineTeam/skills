...
```bash
python3 scripts/manage_skill_dependencies.py plan agent-manager --host codex
python3 scripts/manage_skill_dependencies.py install agent-manager --host codex --execute
```
