...
```bash
python3 scripts/manage_skill_dependencies.py plan agent-model-router --host codex
python3 scripts/manage_skill_dependencies.py install agent-model-router --host codex --execute
```
