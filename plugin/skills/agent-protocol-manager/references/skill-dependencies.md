...
```bash
python3 scripts/manage_skill_dependencies.py plan agent-protocol-manager --host codex
python3 scripts/manage_skill_dependencies.py install agent-protocol-manager --host codex --execute
```
