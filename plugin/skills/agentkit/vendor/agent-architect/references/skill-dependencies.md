...
```bash
python3 scripts/manage_skill_dependencies.py plan agent-architect --host codex
python3 scripts/manage_skill_dependencies.py install agent-architect --host codex --execute
```
