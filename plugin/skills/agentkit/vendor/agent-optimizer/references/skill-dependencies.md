...
```bash
python3 scripts/manage_skill_dependencies.py plan agent-optimizer --host codex
python3 scripts/manage_skill_dependencies.py install agent-optimizer --host codex --execute
```
