...
```bash
python3 scripts/manage_skill_dependencies.py plan agent-refactor --host codex
python3 scripts/manage_skill_dependencies.py install agent-refactor --host codex --execute
```
