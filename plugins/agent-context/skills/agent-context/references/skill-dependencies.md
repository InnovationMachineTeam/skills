...
```bash
python3 scripts/manage_skill_dependencies.py plan agent-context --host codex
python3 scripts/manage_skill_dependencies.py install agent-context --host codex --execute
```
