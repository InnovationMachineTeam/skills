#!/usr/bin/env python3
"""Validate agent-knowledge-manager routing and safety fixtures."""
...
ROUTES = {"ingest", "curate", "publish", "retrieve", "refresh", "graphify", "retire"}
SCENARIOS = {"poisoning", "stale", "deletion", "access-denial", "missing-provenance", "index-drift", "contradiction"}
...
def main() -> int:
    ...
    if failures:
        return 1
    print("PASS agent-knowledge-manager eval fixtures")
    return 0
