#!/usr/bin/env python3
"""Validate agent-team-manager eval fixtures."""
...
ROUTES = {"assess", "design", "build", "map-capabilities", "operate", "change", "recover", "retire"}
...
def main() -> int:
    ...
    if failures:
        return 1
    print("PASS agent-team-manager eval fixtures")
    return 0
