...
> Текущий статус: `1.0.0`. Навык создан как reviewable package. Он не выполняет публикацию, глобальную установку, удаление прежней структуры или миграционный cutover без явного разрешения.
