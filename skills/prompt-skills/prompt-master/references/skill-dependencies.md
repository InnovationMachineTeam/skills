...
```bash
python3 scripts/manage_skill_dependencies.py plan prompt-master --host codex
python3 scripts/manage_skill_dependencies.py install prompt-master --host codex --execute
```
